...
DISTFILES *= "" \
    output/boggle-expected-output-1.txt \
    output/boggle-expected-output-2.txt \
    output/boggle-expected-output-3.txt \
    output/boggle-expected-output-4.txt \
    output/huffman-expected-output-1.txt \
    output/input-1.txt \
    output/input-4.txt \
    res/Banff.jpg \
    res/all_ascii.txt \
